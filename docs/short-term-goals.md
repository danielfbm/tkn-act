...
| 6 | **Pipeline results** (`Pipeline.spec.results`) | Surfaces a final value at the run level; consumers / agents read it from `run-end`. | Type exists; resolver/JSON output don't surface them. Small. |
